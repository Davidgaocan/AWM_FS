...
class evSimba:
    ...
    def get_nearmisdis_with_w(self):
        ...
        for i in range(len(self.X)):
            ...
            sum_nh = self.getDiswithWeight(i, NearHit)

            nearmisdis.append(sum_nm-sum_nh)
    ...
    def reliefF(self, T,t_Close,outputfile='../../out/exmp2/xor_w.csv', sample_way_isSampleWeight=True):
        ...
        old_margin=self.get_margin_with_w(self.W,self.init_w)
        ...
        while(True):
            ...
            new_margin = self.get_margin_with_w(W_new,W_new)
    ...
    def get_final(self,cooling_rate):
        ...
        while(True):
            ...
            for i in range(non_minus_ones_count):
                ...
                new_margin = self.get_margin_with_w(w_new,self.W)
...
if __name__ == '__main__':
    a=0
    # x,y=utiles.get_scaler_data('../data/xor_dataset.csv')
    # a=evSimba(x,y,1,1,1)
