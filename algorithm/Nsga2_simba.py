...
from algorithm.evSimba import evSimba
...
class NSGA2_simba:
    ...
    def evaluate_fitness(self, individual):
        ...
        if (len(feature_indices)==0):
            ...
            a=evSimba(self.x,self.y,0.01,1,1)
            margin=a.get_margin_with_w(individual,individual)
            # print(avg_error_rate)
            # 适应度函数2：特征个数
            # num_selected_features = len(feature_indices)
            return avg_error_rate, margin
...
if __name__ == '__main__':
    ...
    # a=NSGA2_simba(1,10,10,[0.5,0.5,0.5,0.0,0,0,0,0,0,0],X_train,y_train)
    # print(a.get_subset())
    # print(a.get_subset().fitness.values)
