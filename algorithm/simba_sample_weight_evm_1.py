...
适用于多分类问题
'''
class Simba_sample_weight_evm_1:
    ...
    def reliefF(self, outputfile='../../out/exmp2/xor_w.csv', sample_way_isSampleWeight=True):
        ...
        while(True):
            ...
            # 0.02
            if((math.isclose(new_margin,old_margin,abs_tol=0.001)&flag)|(flag&(t_while>=20))|((not flag)&(t_while>=100))):
                print('old==new')
                # if(new_margin<0):
                #     t_while=0
                #     continue
